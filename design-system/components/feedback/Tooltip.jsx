...
export function Tooltip({ content, placement = 'top', children, style, ...rest }) {
  ...
  return (
    ...
    >
      ...
      {show && (
        <span style={{
          position: 'absolute', zIndex: 'var(--z-overlay)', whiteSpace: 'nowrap',
          background: 'var(--delta-charcoal)', color: '#fff',
          fontFamily: 'var(--font-sans)', fontWeight: 'var(--fw-light)',
          fontSize: 'var(--fs-caption)', padding: '6px 10px', borderRadius: 0,
          ...pos[placement], ...style,
        }}>{content}</span>
      )}
    </span>
