...
export interface AngularBannerProps extends Omit<React.HTMLAttributes<HTMLElement>, 'title'> {
...
export function AngularBanner({
  ...
  return (
    ...
    >
      ...
      {media && <div style={{ position: 'absolute', right: 0, bottom: 0, zIndex: 1 }}>{media}</div>}
    </section>
  );
}
