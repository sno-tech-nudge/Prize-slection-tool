 ...
 *  IS that prompt, with the applicant's actual field values substituted in. */
...
Synthesise the inputs you're given rather than listing them. The synopsis should help the juror understand, in \
order: what the organisation does → who it works with → how the model works → what role regenerative agriculture \
plays → what's distinctive about the model → what problem/barrier the model addresses → what is proposed, presented \
...
Length: 100-130 words. Format: one short paragraph. Tone: clear, factual, neutral, and easy for a senior external \
jury member to scan quickly.
